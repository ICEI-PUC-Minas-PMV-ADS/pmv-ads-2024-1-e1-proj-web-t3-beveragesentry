...
|:---|:---|
| Resultados obtidos | A aplicação foi capaz de gerar gráfico de desempenho de vendas indicando individualmente cada produto e a quantidade comercializada.  A aplicação necessita de um botão de reset para criar novo indicativo das vendas e gráfico.  |
| Responsável pela execução do caso de Teste | Danillo A. F. Neves |
...
|Caso de Teste    | CT-7 - A aplicação deve ser capaz de registrar a saída de mercadorias. |
|:---|:---|
...
|Caso de Teste    | CT-8 - A aplicaçao ser responsável por cadastrar novos itens no estoque. |
|:---|:---|
| Resultados obtidos |  Como é observado no "item 16 e 17" ao inserir os dados, o produto é inserido no localstorage cadastrando o mesmo no estoque.|
| Responsável pela execução do caso de Teste | Jaimir |
